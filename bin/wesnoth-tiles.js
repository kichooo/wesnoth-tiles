...
(function (WesnothTiles) {
    ...
    (function (Internal) {
        ...
        Internal.loadWorker = function () {
            var blob = new Blob([Internal.workerString], { type: 'application/javascript' });
...
(function (WesnothTiles) {
    ...
    (function (Worker) {
        ...
        var getRotatedPos = function (pos, rot) {
            if (rot === 0)
                return pos;
            return rotationsMap.get(rot).get(pos.q).get(pos.r);
        };
        var rotationsMap = new Map();
        ...
        var replaceRotation = function (input, rot, rotations) {
        ...
        var getImgName = function (hex, img, tg, rot, translatedPostfix) {
            var imgName;
        ...
        var performRotatedTerrainGraphics = function (tg, dp, rot) {
            if (rot === void 0) { rot = 0; }
            ...
            for (var i = 0; i < tg.tiles.length; i++) {
                ...
                if (!checkFlags(rot, tg.rotations, tile.set_no_flag, hex.flags))
                    return;
            }
            var drawableDatas = [];
        ...
        var performTerrainGraphics = function (tg, dp) {
...
(function (WesnothTiles) {
    ...
    (function (Worker) {
        'use strict';
        var getTerrainMap = function (terrains) {
            if (terrains === undefined)
                return undefined;
            var terrainList = new Map();
        ...
        var GENERIC_SINGLE_PLFB = function (tgGroup, terrains, overlays, fog, imageStem, plfb) {
            var img = {
                name: imageStem,
                layer: plfb.layer,
        ...
        var GENERIC_SINGLE_RANDOM_LFB = function (tgGroup, terrains, overlays, fog, imageStem, lfb) {
        ...
        var BORDER_RESTRICTED_PLFB = function (tgGroup, terrains, fog, adjacent, fogAdjacent, imageStem, plfb) {
            var img = {
                name: imageStem,
                postfix: \"-@R0\",
                layer: plfb.layer,
        ...
        var BORDER_RESTRICTED6_PLFB = function (tgGroup, terrains, fog, adjacent, fogAdjacent, imageStem, plfb) {
            var img = {
                name: imageStem,
        ...
        var BORDER_RESTRICTED4_PLFB = function (tgGroup, terrains, fog, adjacent, fogAdjacent, imageStem, plfb) {
            var img = {
                name: imageStem,
                postfix: \"-@R0-@R1-@R2-@R3\",
                layer: plfb.layer,
        ...
        var BORDER_RESTRICTED3_PLFB = function (tgGroup, terrains, fog, adjacent, fogAdjacent, imageStem, plfb) {
            var img = {
                name: imageStem,
                postfix: \"-@R0-@R1-@R2\",
                layer: plfb.layer,
        ...
        var BORDER_RESTRICTED2_PLFB = function (tgGroup, terrains, fog, adjacent, fogAdjacent, imageStem, plfb) {
            var img = {
                name: imageStem,
                postfix: \"-@R0-@R1\",
                layer: plfb.layer,
        ...
        var BORDER_RESTRICTED6_RANDOM_LFB = function (tgGroup, terrains, fog, adjacent, fogAdjacent, imageStem, lfb) {
        ...
        var BORDER_RESTRICTED4_RANDOM_LFB = function (tgGroup, terrains, fog, adjacent, fogAdjacent, imageStem, lfb) {
        ...
        var BORDER_RESTRICTED3_RANDOM_LFB = function (tgGroup, terrains, fog, adjacent, fogAdjacent, imageStem, lfb) {
        ...
        var BORDER_RESTRICTED2_RANDOM_LFB = function (tgGroup, terrains, fog, adjacent, fogAdjacent, imageStem, lfb) {
        ...
        var BORDER_RESTRICTED_RANDOM_LFB = function (tgGroup, terrains, fog, adjacent, fogAdjacent, imageStem, lfb) {
        ...
        var BORDER_COMPLETE_LFB = function (tgGroup, terrains, fog, adjacent, fogAdjacent, imageStem, lfb, grades) {
        ...
        Worker.TRANSITION_COMPLETE_LFB = function (tgGroup, terrains, adjacent, imageStem, lfb, grades) {
            if (grades === void 0) { grades = [1, 2, 3, 4, 5, 6]; }
            if (lfb.layer === undefined)
                lfb.layer = -500;
            if (lfb.flag === undefined)
                lfb.flag = \"transition\";
        ...
        var GENERIC_SINGLEHEX_PLFB = function (tgGroup, terrains, imageStem, plfb) {
            var img = {
                name: imageStem,
                layer: plfb.layer,
                center: { x: 36, y: 36 },
        ...
        var GENERIC_RESTRICTED3_RANDOM_LFB = function (tgGroup, terrains, adjacent, imageStem, lfb, rotation) {
        ...
        var GENERIC_RESTRICTED2_RANDOM_LFB = function (tgGroup, terrains, adjacent, imageStem, lfb, rotation) {
        ...
        var GENERIC_RESTRICTED_RANDOM_LFB = function (tgGroup, terrains, adjacent, imageStem, lfb, rotation) {
        ...
        var GENERIC_COMPLETE_LFB = function (tgGroup, terrains, adjacent, imageStem, lfb) {
        ...
        var GENERIC_RESTRICTED3_N_NE_SE_PLFB = function (tgGroup, terrains, adjacent, imageStem, plfb, rotation) {
            var img = {
                name: imageStem,
                postfix: rotation,
                layer: plfb.layer,
        ...
        var GENERIC_RESTRICTED3_N_NE_S_PLFB = function (tgGroup, terrains, adjacent, imageStem, plfb, rotation) {
            var img = {
                name: imageStem,
                postfix: rotation,
                layer: plfb.layer,
        ...
        var GENERIC_RESTRICTED3_N_NE_SW_PLFB = function (tgGroup, terrains, adjacent, imageStem, plfb, rotation) {
            var img = {
                name: imageStem,
                postfix: rotation,
                layer: plfb.layer,
        ...
        var GENERIC_RESTRICTED3_N_SE_SW_PLFB = function (tgGroup, terrains, adjacent, imageStem, plfb, rotation) {
            var img = {
                name: imageStem,
                postfix: rotation,
                layer: plfb.layer,
        ...
        var GENERIC_RESTRICTED3_PLFB = function (tgGroup, terrains, adjacent, imageStem, plfb, rotation) {
        ...
        var GENERIC_RESTRICTED2_N_NE_PLFB = function (tgGroup, terrains, adjacent, imageStem, plfb, rotation) {
            var img = {
                name: imageStem,
                postfix: rotation,
                layer: plfb.layer,
        ...
        var GENERIC_RESTRICTED2_N_SE_PLFB = function (tgGroup, terrains, adjacent, imageStem, plfb, rotation) {
            var img = {
                name: imageStem,
                postfix: rotation,
                layer: plfb.layer,
        ...
        var GENERIC_RESTRICTED2_N_S_PLFB = function (tgGroup, terrains, adjacent, imageStem, plfb, rotation) {
            var img = {
                name: imageStem,
                postfix: rotation,
                layer: plfb.layer,
        ...
        var GENERIC_RESTRICTED2_PLFB = function (tgGroup, terrains, adjacent, imageStem, plfb, rotation) {
        ...
        var GENERIC_RESTRICTED_PLFB = function (tgGroup, terrains, overlays, adjacent, adjacentOverlays, imageStem, plfb, rotation) {
            var img = {
                name: imageStem,
                postfix: rotation,
                layer: plfb.layer,
        ...
        var CORNER_PLFB_CONVEX = function (tgGroup, terrains, adjacent, imageStem, plfb) {
            // 0 [\"tr\", \"r\", \"br\", \"bl\", \"l\", \"tl\"]
            tgGroup.addTg({
                tiles: [{
                    q: 0,
        ...
        var CORNER_PLFB_CONCAVE = function (tgGroup, terrains, adjacent, imageStem, plfb) {
            // 0 [\"tr\", \"r\", \"br\", \"bl\", \"l\", \"tl\"]
            tgGroup.addTg({
                tiles: [{
                    q: 0,
...
(function (WesnothTiles) {
    ...
    (function (Worker) {
        'use strict';
        Worker.swapTerrains = function (terrains) {
            var terrainList = [];
            for (var i = 0; i < 21 /* VOID */; i++) {
                if (terrains.indexOf(i) === -1)
                    terrainList.push(i);
            }
            return terrainList;
        };
        var addSparseForestMacro = function (tgGroup, overlay, imagestem) {
        ...
        var addForestMacro = function (tgGroup, overlay, imagestem) {
        ...
        var TgGroup = (function () {
            ...
            TgGroup.prototype.populateTgs = function () {
                ...
                Worker.FOG_TRANSITION_LFB(this, true, false, \"fog/fog\", { layer: 999, flag: \"fog\" });
                // chasms transitions
                ...
                Worker.WALL_TRANSITION_PLFB(this, [20 /* ABYSS */], Worker.swapTerrains([20 /* ABYSS */]), \"chasm/regular\", { layer: -90, flag: \"ground\" });
                // transitions --------------------------
                Worker.TRANSITION_COMPLETE_LFB(this, [9 /* MOUNTAIN_DRY */, 11 /* MOUNTAIN_VOLCANO */], Worker.swapTerrains([9 /* MOUNTAIN_DRY */, 5 /* HILLS_DRY */, 11 /* MOUNTAIN_VOLCANO */, 18 /* WATER_OCEAN */, 19 /* WATER_COAST_TROPICAL */, 17 /* SWAMP_WATER */, 16 /* SWAMP_MUD */, 20 /* ABYSS */]), \"mountains/dry\", { layer: -166 }, [1]);
                ...
                Worker.TRANSITION_COMPLETE_LFB(this, [8 /* MOUNTAIN_BASIC */], [5 /* HILLS_DRY */, 6 /* HILLS_DESERT */, 2 /* GRASS_DRY */, 7 /* HILLS_SNOW */, 15 /* SAND_DESERT */, 14 /* SAND_BEACH */, 13 /* FROZEN_ICE */, 12 /* FROZEN_SNOW */], \"hills/dry\", { layer: -166 }, [1, 2]);
                Worker.TRANSITION_COMPLETE_LFB(this, [10 /* MOUNTAIN_SNOW */], [5 /* HILLS_DRY */, 6 /* HILLS_DESERT */, 2 /* GRASS_DRY */, 15 /* SAND_DESERT */, 14 /* SAND_BEACH */], \"hills/dry\", { layer: -166 }, [1, 2]);
                Worker.TRANSITION_COMPLETE_LFB(this, [7 /* HILLS_SNOW */, 10 /* MOUNTAIN_SNOW */], [5 /* HILLS_DRY */, 4 /* HILLS_REGULAR */], \"hills/snow-to-hills\", { layer: -170 }, [1, 2]);
                Worker.TRANSITION_COMPLETE_LFB(this, [7 /* HILLS_SNOW */, 10 /* MOUNTAIN_SNOW */], [18 /* WATER_OCEAN */, 19 /* WATER_COAST_TROPICAL */, 17 /* SWAMP_WATER */, 16 /* SWAMP_MUD */], \"hills/snow-to-water\", { layer: -171 }, [1, 2]);
                Worker.TRANSITION_COMPLETE_LFB(this, [7 /* HILLS_SNOW */, 10 /* MOUNTAIN_SNOW */], [6 /* HILLS_DESERT */, 2 /* GRASS_DRY */, 1 /* GRASS_SEMI_DRY */, 0 /* GRASS_GREEN */, 3 /* GRASS_LEAF_LITTER */, 15 /* SAND_DESERT */, 14 /* SAND_BEACH */, 13 /* FROZEN_ICE */, 12 /* FROZEN_SNOW */], \"hills/snow\", { layer: -172 }, [1, 2]);
                Worker.TRANSITION_COMPLETE_LFB(this, [4 /* HILLS_REGULAR */, 8 /* MOUNTAIN_BASIC */], Worker.swapTerrains([4 /* HILLS_REGULAR */, 18 /* WATER_OCEAN */, 19 /* WATER_COAST_TROPICAL */, 16 /* SWAMP_MUD */, 17 /* SWAMP_WATER */, 20 /* ABYSS */, 8 /* MOUNTAIN_BASIC */, 11 /* MOUNTAIN_VOLCANO */, 9 /* MOUNTAIN_DRY */]), \"hills/regular\", { layer: -180 }, [1, 2]);
                Worker.TRANSITION_COMPLETE_LFB(this, [5 /* HILLS_DRY */], Worker.swapTerrains([5 /* HILLS_DRY */, 18 /* WATER_OCEAN */, 19 /* WATER_COAST_TROPICAL */, 16 /* SWAMP_MUD */, 17 /* SWAMP_WATER */, 10 /* MOUNTAIN_SNOW */, 8 /* MOUNTAIN_BASIC */, 4 /* HILLS_REGULAR */, 7 /* HILLS_SNOW */]), \"hills/dry\", { layer: -183 }, [1, 2]);
                Worker.TRANSITION_COMPLETE_LFB(this, [6 /* HILLS_DESERT */], Worker.swapTerrains([6 /* HILLS_DESERT */, 18 /* WATER_OCEAN */, 19 /* WATER_COAST_TROPICAL */, 20 /* ABYSS */, 10 /* MOUNTAIN_SNOW */, 8 /* MOUNTAIN_BASIC */, 7 /* HILLS_SNOW */, 4 /* HILLS_REGULAR */, 5 /* HILLS_DRY */]), \"hills/desert\", { layer: -184 }, [1, 2]);
                Worker.TRANSITION_COMPLETE_LFB(this, [17 /* SWAMP_WATER */], Worker.swapTerrains([17 /* SWAMP_WATER */, 6 /* HILLS_DESERT */, 5 /* HILLS_DRY */, 4 /* HILLS_REGULAR */, 7 /* HILLS_SNOW */, 10 /* MOUNTAIN_SNOW */, 8 /* MOUNTAIN_BASIC */, 9 /* MOUNTAIN_DRY */, 12 /* FROZEN_SNOW */, 13 /* FROZEN_ICE */, 20 /* ABYSS */]), \"swamp/water\", { layer: -230 }, [1, 2, 3]);
                ...
                Worker.TRANSITION_COMPLETE_LFB(this, [3 /* GRASS_LEAF_LITTER */], [16 /* SWAMP_MUD */, 15 /* SAND_DESERT */, 14 /* SAND_BEACH */, 12 /* FROZEN_SNOW */], \"grass/leaf-litter\", { layer: -270 }, [1, 2, 3]);
                ...
                Worker.TRANSITION_COMPLETE_LFB(this, [14 /* SAND_BEACH */], Worker.swapTerrains([14 /* SAND_BEACH */, 5 /* HILLS_DRY */, 18 /* WATER_OCEAN */, 19 /* WATER_COAST_TROPICAL */, 13 /* FROZEN_ICE */, 16 /* SWAMP_MUD */, 17 /* SWAMP_WATER */, 20 /* ABYSS */, 6 /* HILLS_DESERT */, 3 /* GRASS_LEAF_LITTER */, 1 /* GRASS_SEMI_DRY */, 2 /* GRASS_DRY */, 0 /* GRASS_GREEN */, 8 /* MOUNTAIN_BASIC */, 10 /* MOUNTAIN_SNOW */, 7 /* HILLS_SNOW */, 4 /* HILLS_REGULAR */, 8 /* MOUNTAIN_BASIC */, 12 /* FROZEN_SNOW */, 16 /* SWAMP_MUD */]), \"sand/beach\", { layer: -510 }, [1, 2, 3, 4, 6]);
                Worker.TRANSITION_COMPLETE_LFB(this, [15 /* SAND_DESERT */], Worker.swapTerrains([15 /* SAND_DESERT */, 18 /* WATER_OCEAN */, 19 /* WATER_COAST_TROPICAL */, 13 /* FROZEN_ICE */, 12 /* FROZEN_SNOW */, 16 /* SWAMP_MUD */, 17 /* SWAMP_WATER */, 20 /* ABYSS */, 8 /* MOUNTAIN_BASIC */, 10 /* MOUNTAIN_SNOW */, 7 /* HILLS_SNOW */, 4 /* HILLS_REGULAR */, 5 /* HILLS_DRY */, 6 /* HILLS_DESERT */, 1 /* GRASS_SEMI_DRY */, 2 /* GRASS_DRY */, 0 /* GRASS_GREEN */, 3 /* GRASS_LEAF_LITTER */, 16 /* SWAMP_MUD */, 14 /* SAND_BEACH */]), \"sand/desert\", { layer: -510 }, [1, 2, 3, 4, 6]);
                Worker.TRANSITION_COMPLETE_LFB(this, [4 /* HILLS_REGULAR */, 8 /* MOUNTAIN_BASIC */], [18 /* WATER_OCEAN */, 19 /* WATER_COAST_TROPICAL */, 13 /* FROZEN_ICE */, 16 /* SWAMP_MUD */, 17 /* SWAMP_WATER */], \"hills/regular-to-water\", { layer: -482, flag: \"non_submerged\" }, [1, 2]);
                Worker.TRANSITION_COMPLETE_LFB(this, [5 /* HILLS_DRY */, 9 /* MOUNTAIN_DRY */, 11 /* MOUNTAIN_VOLCANO */], [18 /* WATER_OCEAN */, 19 /* WATER_COAST_TROPICAL */, 13 /* FROZEN_ICE */, 16 /* SWAMP_MUD */, 17 /* SWAMP_WATER */], \"hills/dry-to-water\", { layer: -482, flag: \"non_submerged\" }, [1, 2]);
                Worker.TRANSITION_COMPLETE_LFB(this, [2 /* GRASS_DRY */, 0 /* GRASS_GREEN */, 3 /* GRASS_LEAF_LITTER */, 1 /* GRASS_SEMI_DRY */], [18 /* WATER_OCEAN */, 19 /* WATER_COAST_TROPICAL */, 13 /* FROZEN_ICE */], \"flat/bank-to-ice\", { layer: -483, flag: \"non_submerged\" }, [1, 2]);
                Worker.TRANSITION_COMPLETE_LFB(this, [13 /* FROZEN_ICE */, 12 /* FROZEN_SNOW */], [15 /* SAND_DESERT */, 14 /* SAND_BEACH */], \"frozen/ice\", { layer: -485, flag: \"non_submerged\" }, [1, 2, 3, 4]);
                Worker.TRANSITION_COMPLETE_LFB(this, [7 /* HILLS_SNOW */, 10 /* MOUNTAIN_SNOW */, 13 /* FROZEN_ICE */, 12 /* FROZEN_SNOW */], [18 /* WATER_OCEAN */, 19 /* WATER_COAST_TROPICAL */, 16 /* SWAMP_MUD */, 17 /* SWAMP_WATER */], \"frozen/ice\", { layer: -485, flag: \"non_submerged\" }, [1, 2, 3, 4]);
                Worker.TRANSITION_COMPLETE_LFB(this, [7 /* HILLS_SNOW */, 10 /* MOUNTAIN_SNOW */, 13 /* FROZEN_ICE */, 12 /* FROZEN_SNOW */], [18 /* WATER_OCEAN */, 19 /* WATER_COAST_TROPICAL */, 16 /* SWAMP_MUD */, 17 /* SWAMP_WATER */], \"frozen/ice-to-water\", { layer: -505, flag: \"submerged\" }, [1, 2, 3, 4]);
                // invisible transition
                Worker.TRANSITION_COMPLETE_LFB(this, [13 /* FROZEN_ICE */], [18 /* WATER_OCEAN */, 19 /* WATER_COAST_TROPICAL */, 17 /* SWAMP_WATER */], \"frozen/ice-to-water\", { layer: -1001 }, [1, 2, 3, 4]);
                ...
                Worker.TRANSITION_COMPLETE_LFB(this, [21 /* VOID */], Worker.swapTerrains([]), \"void/void\", { layer: 1000 }, [1, 2, 3]);
                return TgGroup;
            };
            return TgGroup;
        })();
...
(function (WesnothTiles) {
    ...
    (function (Worker) {
         ...
         */
        Worker.murmurhash3 = function (key, seed) {
...
(function (WesnothTiles) {
    ...
    (function (_Worker) {
        ...
        var Worker = (function () {
            function Worker() {
                ...
                this.rebuild = function (mapId) {
                    ...
                    map.unsetLoadingMode();
                    var drawables = _Worker.rebuild(map);
                    drawables.sort(sortFunc);
                    return drawables;
                };
                this.getChecksum = function (mapId) {
                    var map = ensureMap(mapId);
                    var drawables = _this.rebuild(mapId);
                    var checksum = 0;
                ...
                onmessage = function (oEvent) {
                    var order = oEvent.data;
                    var func = _this[order.func];
        ...
        var sortFuncForChecksum = function (a, b) {
            if (a.layer === b.layer) {
                if (a.base !== undefined && b.base !== undefined) {
