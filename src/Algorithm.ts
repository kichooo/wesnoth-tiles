...
module WesnothTiles {
  ...
  export var rebuild = (hexMap: HexMap) => {
    ...
    TRANSITION_COMPLETE_LFB(terrainGraphics,
      getTerrainMap([ETerrain.HILLS_SNOW, ETerrain.MOUNTAIN_SNOW]), getTerrainMap([ETerrain.HILLS_DRY]), 
    ...
    TRANSITION_COMPLETE_LFB(terrainGraphics,
      getTerrainMap([ETerrain.GRASS_SEMI_DRY]), getTerrainMap([ETerrain.SAND_DESERT, ETerrain.SAND_BEACH, ETerrain.FROZEN_ICE, ETerrain.FROZEN_SNOW]), 
      "grass/semi-dry-medium", { layer: -260 });

    TRANSITION_COMPLETE_LFB(terrainGraphics,
      getTerrainMap([ETerrain.GRASS_GREEN]), getTerrainMap([ETerrain.SAND_DESERT, ETerrain.SAND_BEACH, ETerrain.FROZEN_ICE, ETerrain.FROZEN_SNOW]), 
      "grass/green-medium", { layer: -261 });

    TRANSITION_COMPLETE_LFB(terrainGraphics,
      getTerrainMap([ETerrain.GRASS_DRY]), getTerrainMap([ETerrain.SAND_DESERT, ETerrain.SAND_BEACH, ETerrain.FROZEN_ICE, ETerrain.FROZEN_SNOW]), 
    ...
    TRANSITION_COMPLETE_LFB(terrainGraphics,
      getTerrainMap([ETerrain.FROZEN_SNOW]), swapTerrainTypes(getTerrainMap([ETerrain.FROZEN_SNOW])), 
    ...
    TRANSITION_COMPLETE_LFB(terrainGraphics,
      getTerrainMap([ETerrain.SAND_BEACH]), swapTerrainTypes(getTerrainMap([ETerrain.SAND_BEACH,
        ETerrain.WATER_OCEAN, ETerrain.WATER_COAST_TROPICAL, ETerrain.FROZEN_ICE])), 
      "sand/beach", { layer: -510 });

    TRANSITION_COMPLETE_LFB(terrainGraphics,
      getTerrainMap([ETerrain.SAND_DESERT]), swapTerrainTypes(getTerrainMap([ETerrain.SAND_DESERT,
        ETerrain.WATER_OCEAN, ETerrain.WATER_COAST_TROPICAL, ETerrain.FROZEN_ICE])), 
    ...
    TRANSITION_COMPLETE_LFB(terrainGraphics,
      getTerrainMap([ETerrain.HILLS_DRY, ETerrain.MOUNTAIN_DRY]), 
      getTerrainMap([ETerrain.WATER_OCEAN, ETerrain.WATER_COAST_TROPICAL, ETerrain.FROZEN_ICE]), 
